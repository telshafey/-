            ...
            <>
                <div className="mt-4 md:mt-0">
                    ...
                    <ul className="space-y-2">
                        <li><Link to="/creative-writing" className="text-gray-600 hover:text-blue-500 transition-colors">الرئيسية</Link></li>
                        <li><Link to="/creative-writing/about" className="text-gray-600 hover:text-blue-500 transition-colors">عن البرنامج</Link></li>
                ...
                <div className="mt-4 md:mt-0">
                    ...
                    <ul className="space-y-2">
                        ...
                        <li><Link to="/creative-writing/instructors" className="text-gray-600 hover:text-blue-500 transition-colors">المدربون</Link></li>
                    </ul>
                </div>
                <div className="mt-4 md:mt-0">
                    <h3 className="font-bold text-gray-800 mb-4">تواصل معنا</h3>
                    <ul className="space-y-2">
                        <li><Link to="/creative-writing/support" className="text-gray-600 hover:text-blue-500 transition-colors">الدعم والمساعدة</Link></li>
                        <li><Link to="/creative-writing/join-us" className="text-gray-600 hover:text-blue-500 transition-colors">انضم لفريقنا</Link></li>
                    </ul>
                </div>
            </>
        );
    ...
    return (
        <>
            <div className="mt-4 md:mt-0">
                ...
                <ul className="space-y-2">
                    <li><Link to="/enha-lak" className="text-gray-600 hover:text-blue-500 transition-colors">الرئيسية "إنها لك"</Link></li>
            ...
            <div className="mt-4 md:mt-0">
                ...
                <ul className="space-y-2">
                    <li><Link to="/store" className="text-gray-600 hover:text-blue-500 transition-colors">متجر "إنها لك"</Link></li>
                </ul>
            </div>
            <div className="mt-4 md:mt-0">
                <h3 className="font-bold text-gray-800 mb-4">تواصل معنا</h3>
