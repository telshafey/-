    ...
    return (
        <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200">
            ...
            <div className="space-y-5">
                ...
                <SummaryItem icon={<Calendar size={18}/>} label="التاريخ" value={selectedDate ? selectedDate.toLocaleDateString('ar-EG', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' }) : null} placeholder="لم يتم الاختيار" isComplete={!!selectedDate}/>
