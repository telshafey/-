...
const faqData = [
    {
        ...
        items: [
            ...
            {
                q: 'ما هي متطلبات حضور الجلسات؟',
                a: 'كل ما تحتاجه هو جهاز كمبيوتر أو تابلت مزود بكاميرا وميكروفون، واتصال إنترنت جيد ومستقر.'
            },
            {
            ...
            {
                q: 'ماذا لو فات طفلي موعد جلسة؟',
                a: 'نرجو إبلاغنا قبل موعد الجلسة بـ 24 ساعة على الأقل لإعادة جدولتها. في حالة عدم الإبلاغ المسبق، قد يتم اعتبار الجلسة مكتملة. نحن نتفهم الظروف الطارئة وسنحاول التعامل معها بمرونة قدر الإمكان.'
            }
        ]
    },
    {
        ...
        items: [
            {
                q: 'ما هي طرق الدفع المتاحة للبرنامج؟',
                a: 'نقبل حاليًا الدفع عبر التحويل البنكي، المحافظ الإلكترونية (مثل فودافون كاش)، وبطاقات الائتمان. ستجد كل التفاصيل عند إتمام عملية الحجز.'
            },
            {
                q: 'هل هناك فترة تجريبية؟',
                a: 'نقدم "باقة الجلسة الاستشارية" بسعر مخفض، وهي فرصة ممتازة لتقييم مستوى الطالب والتعرف على منهجيتنا قبل الالتزام بباقة كاملة.'
            }
        ]
    }
];
...
const supportContent = {
    title: 'الدعم والمساعدة - بداية الرحلة',
    subtitle: 'نحن هنا لمساعدتك في كل ما يخص برنامج الكتابة الإبداعية. تواصل معنا أو تصفح الأسئلة الشائعة.',
    contact_email: 'creative@alrehlah.com',
    contact_phone: '+20 101 202 3030',
};

const CreativeWritingSupportPage: React.FC = () => {
...
export default CreativeWritingSupportPage;